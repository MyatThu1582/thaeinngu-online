...
<div class="container mt-5 mb-5 pb-5 pt-5">
  ...
  <div class="row activitycontainer">
    ...
    <?php
      $stmt = $pdo->prepare("SELECT * FROM activity ORDER BY id DESC");
      $stmt->execute();
      $datas = $stmt->fetchAll();
     ?>
    ...
    <div class="col-4 p-3 full">
            <div class="activity">
                ...
                <div class="p-3">
                  ...
                  <a href="view/activity_detail.php?id=<?php echo $value['id'];?>" class="text-brown d-block link" style="text-align:right;">More Details</a>
                </div>
            </div>
        </div>
        <?php
  ...
  <div class="">
    <a href="view/activity.php" class="btn text-brown float-end" style="font-size:15px; padding:10px; margin-top:-80px;">Check More Activities >></a>
  </div>
</div>
<!-- announcement -->
