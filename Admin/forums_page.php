...
<body>
  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-6 mt-3">
        <div class="header" style="font-size:25px; margin-left:330px; margin-top:20px; width:;">Forums-Listening</div>
      </div>
  ...
  <tbody>
    ...
    <div class="" style="background-color:rgb(63,0,0); width:1500px; height:60px; margin-left:210px; margin-top:534px;">
