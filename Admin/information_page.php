...
<body>
    ...
    if ($_SESSION['role'] != 1) {
      ...
      if ($_POST) {
        ...
        $information  = $db->information_add($bank_acc_name,$acc_name,$phone_number);
      }
  ...
  <div class="">
      ...
      <div class="modal-dialog">
        <div class="modal-content"  style="width:650px; border:3px solid rgb(63,0,0); margin-top:15px;">
          <div class="modal-header">
            <h1 class="modal-title" id="staticBackdropLabel" style="font-size:30px; color:rgb(63,0,0);">Create New Information</h1>
          ...
          <div class="modal-body">
            <form class="" action="" method="post">
              ...
              <div class="m-3 floating mt-2">
                <label for="" style="font-size:18px;">Bank Account Name</label><span style="color:red;" class="ms-2"><?php echo empty($nameError) ? '' : '*'.$nameError; ?></span>
                <input type="text" name="bank_acc_name" placeholder="Enter Your Bank Account Name" class="mt-2 input form-control" style="height:50px; border:2px solid rgb(63,0,0);">
              </div>

              <div class="m-3 floating mt-2">
                <label for="" style="font-size:18px;">Account Number</label><span style="color:red;" class="ms-2"><?php echo empty($nameError) ? '' : '*'.$nameError; ?></span>
                <input type="number" name="acc_name" placeholder="Enter Your Account Number" class="mt-2 input form-control" style="height:50px; border:2px solid rgb(63,0,0);">
              </div>

              <div class="m-3 floating mt-2">
                <label for="" style="font-size:18px;">Phone</label><span style="color:red;" class="ms-2"><?php echo empty($nameError) ? '' : '*'.$nameError; ?></span>
                <input type="number" name="phone_number" placeholder="Enter Your Phone" class="mt-2 input form-control" style="height:50px; border:2px solid rgb(63,0,0);">
              </div>

            <div class="ms-3 me-3 mb-3 floating mt-4">
              <button type="submit" name="add_btn" class="add_btn">Add Information</button>
            </div>
          </div>
        </form>
        </div>
    ...
    <div class="row">
      <div class="col-6 mt-3">
        <div class="header" style="font-size:25px; margin-left:270px; margin-top:20px; width:;">Information-Listening</div>
      </div>
      <div class="col-4 mt-5">
        <button type="button" name="button" class="create_btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="margin-left:70%; width:250px;">Create New Information</button>
      </div>
    </div>
