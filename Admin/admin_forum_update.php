...
<body>
    ...
    if ($_SESSION['role'] != 1) {
      ...
      if (isset($_POST['update_btn'])) {
        if (empty($_POST['title']) || empty($_POST['description'])) {
          ...
          $id = $_GET['id'];
         $update = $db->admin_forums_update($_POST['title'], $_POST['description'], $id);
        }
      }
  ...
  <div class="container" style="width:800px; margin-left:-66%; margin-top:200px;">

  <form class="" action="" method="post">
  <div class="p-2" style=" border:2px solid rgb(63,0,0);  box-shadow:0px 15px 19px  rgb(63,0,0);">
    <div class="ps-3 mt-3" style="font-size:25px; margin-bottom:-20px;"><b>Forums-Update</b></div>
    <a href="forums_page.php"><button type="button" name="button" class="back_btn">Back</button></a>
